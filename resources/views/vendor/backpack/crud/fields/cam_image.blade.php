...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="row">
        ...
        <div class="col-sm-3" data-handle="previewArea">
            <div class="docs-preview clearfix">
                <div id="my_camera" class="img-preview preview-lg">
    ...
    <div class="btn-group">
        <div class="btn btn-light btn-sm btn-file">
            ...
            <input type="hidden" data-handle="hiddenImage" name="{{ $field['name'] }}" value="{{ $value."?".time() }}">
        </div>
        @if(isset($field['crop']) && $field['crop'])
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            function bpFieldInitBase64CropperImageElement(element) {
                    ...
                    var $preview = document.getElementById('my_camera');
